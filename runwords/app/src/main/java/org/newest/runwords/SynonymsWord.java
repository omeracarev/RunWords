...
public class SynonymsWord extends AppCompatActivity {
    private ImageView leftarsy,rightarsy,helprunnsy,runnyimsy,mainrunny;
    ...
    private int bundleIndex = 3;

    private ArrayList<String> sygur1 = new ArrayList<>(Arrays.asList(new synwords().col1words));
    private ArrayList<String> sygur2 = new ArrayList<>(Arrays.asList(new synwords().col2words));
    private ArrayList<String> sygur3 = new ArrayList<>(Arrays.asList(new synwords().coltrwords));
    private int[] allrawsop = new synwords().colrawsop;
    private int[] allrawscop = new synwords().colrawscop;
    ...
    private String colorop = "#00ACC1";
    private String colorcop = "#e05d5d";
    ...
    private TextView choosertextty,helpidletexty,corscore,wrongscore,runnyscore,op1drag,op2drag,op3drag,op4drag,op5drag,cop1drag,cop2drag,cop3drag,cop4drag,cop5drag;
    ...
    private void menuPopup(Context context){
        ...
        popUp.setBackgroundDrawable(context.getResources().getDrawable(R.drawable.bgtransparent,SynonymsWord.this.getTheme()));
...
// AlarmManager'a bildirimi ayarla
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_synonyms_word);

        Context context = SynonymsWord.this.getApplicationContext();
        realtimeNotification(context);
        rewardedAdset();

        realtimeNotification(SynonymsWord.this);
        ...
        leftarsy = findViewById(R.id.leftarsy);
        rightarsy = findViewById(R.id.rightarsy);
        choosertextty = findViewById(R.id.choosertextsy);
        helpidletexty = findViewById(R.id.helpidletextsy);
        corscore = findViewById(R.id.corscoresy);
        wrongscore = findViewById(R.id.wrongscoresy);
        runnyscore = findViewById(R.id.runnyscoresy);
        helprunnsy = findViewById(R.id.helprunnsy);
        runnyimsy = findViewById(R.id.runnyimsy);
        mainrunny = findViewById(R.id.mainrunnysy);

        databaseHelper = new DatabaseHelper(SynonymsWord.this);
        ...
        op1drag = findViewById(R.id.op1drag);
        op2drag = findViewById(R.id.op2drag);
        op3drag = findViewById(R.id.op3drag);
        op4drag = findViewById(R.id.op4drag);
        op5drag = findViewById(R.id.op5drag);
        cop1drag = findViewById(R.id.cop1drag);
        cop2drag = findViewById(R.id.cop2drag);
        cop3drag = findViewById(R.id.cop3drag);
        cop4drag = findViewById(R.id.cop4drag);
        cop5drag = findViewById(R.id.cop5drag);
        ...
        op1drag.setTag(R.string.cards,R.id.op1card);
        op2drag.setTag(R.string.cards,R.id.op2card);
        op3drag.setTag(R.string.cards,R.id.op3card);
        op4drag.setTag(R.string.cards,R.id.op4card);
        op5drag.setTag(R.string.cards,R.id.op5card);

        cop1drag.setTag(R.string.cards,R.id.cop1card);
        cop2drag.setTag(R.string.cards,R.id.cop2card);
        cop3drag.setTag(R.string.cards,R.id.cop3card);
        cop4drag.setTag(R.string.cards,R.id.cop4card);
        cop5drag.setTag(R.string.cards,R.id.cop5card);
        ...
        getPassingClass(rightarsy);
         ...
         initializeGroups();
        initializeİdleAnim(findViewById(R.id.correctimsy),Techniques.Tada);
        initializeİdleAnim(findViewById(R.id.wrongimsy),Techniques.Tada);
        initializeİdleAnim(findViewById(R.id.runnyimsy),Techniques.Tada);
        initializeİdleAnim(findViewById(R.id.mainrunnysy),Techniques.Tada);
        initializeİdleAnim(findViewById(R.id.helprunnsy),Techniques.Tada);
        initializeİdleAnim(findViewById(R.id.helpidletextsy),Techniques.SlideInLeft);
    ...
    private void darkenBackground(Float bgcolor) {
        SynonymsWord mMainActivity = SynonymsWord.this;
    ...
    private void helpinRunnie(){
        ...
        if (runnies>0){
            runnies--;
            runnyscore.setText("x"+runnies);
            LinearLayout cardopgroup = findViewById(R.id.cardopgroup);
            LinearLayout cardcopgroup = findViewById(R.id.cardcopgroup);
                ...
                for (int j=0; j<cardcopgroup.getChildCount(); j++) {
                    ...
                    if (textView.getTag(R.string.trmean).toString().equalsIgnoreCase(textView2.getTag(R.string.trmean).toString())){
                        if (cardView.isShown()&&cardView2.isShown()){
                            ...
                            commeRunny.add(textView.getText().toString()+" ile "+textView2.getText().toString()+" kelimelerini dene bence...");
                            commeRunny.add(textView.getText().toString()+" ile "+textView2.getText().toString()+" kulağa benzer geliyor...");
                            commeRunny.add(textView.getText().toString()+" ve "+textView2.getText().toString()+" birbiri için yaratılmış...");
                            commeRunny.add(textView.getText().toString()+" ve "+textView2.getText().toString()+" birbirinin ikinci anlamı olabilir...");
                            ...
                            initParticuleEfect(50,1200,0.2f,0.5f,0,270,cardView2,50,R.drawable.ic_corkonfet);
            ...
            ProgressDialog progressDialog = new ProgressDialog(SynonymsWord.this);
            ...
            if (mRewardedAd!=null){
                ...
                Snackbar snackbar = Snackbar.make(findViewById(R.id.synlays),"Runny'e bir daha dokunun", BaseTransientBottomBar.LENGTH_LONG);
    ...
    private void rewardAd(){
        Activity activityContext = SynonymsWord.this;
        mRewardedAd.show(activityContext, new OnUserEarnedRewardListener() {
            ...
            public void onUserEarnedReward(@NonNull RewardItem rewardItem) {
                ...
                DatabaseHelper databaseHelper = new DatabaseHelper(SynonymsWord.this);
    ...
    private void initializeGroups(){
        ...
        optexts.add(findViewById(R.id.op1drag));
        optexts.add(findViewById(R.id.op2drag));
        optexts.add(findViewById(R.id.op3drag));
        optexts.add(findViewById(R.id.op4drag));
        optexts.add(findViewById(R.id.op5drag));

        coptexts.add(findViewById(R.id.cop1drag));
        coptexts.add(findViewById(R.id.cop2drag));
        coptexts.add(findViewById(R.id.cop3drag));
        coptexts.add(findViewById(R.id.cop4drag));
        coptexts.add(findViewById(R.id.cop5drag));
    ...
    private void initParticuleEfect(int maxParticles,int timetToLive,float speedMin,float speedMax,int minAngle,int maxAngle,View view,int numParticles,int drawim){
       if (checkInfo()){
           new ParticleSystem(SynonymsWord.this,maxParticles,drawim,timetToLive)
            ...
            for (int j=0; j<cardcopgroup.getChildCount();j++){
                ...
                if (cardop.getTag(R.string.focused).toString().equalsIgnoreCase("trueop")&&cardcop.getTag(R.string.focused).toString().equalsIgnoreCase("truecop")){
                    ...
                    if (optext.getTag(R.string.otherspl).toString().equalsIgnoreCase(coptext.getTag(R.string.otherspl).toString())){
                        ...
                        countdown++;
                        truescore++;
                        initParticuleEfect(50,500,0.2f,0.5f,270,-360,findViewById(R.id.correctimsy),50,R.drawable.ic_corkonfet);
                        corscore.setText("x"+truescore);
                        corscore.setText("x"+truescore);
                        if(truescore>=50){
                            opensuccPop(SynonymsWord.this);
                            runnies=runnies+3;
                       ...
                       runnyscore.setText("x"+runnies);
                        ...
                        initParticuleEfect(50,500,0.2f,0.5f,-180,360,findViewById(R.id.wrongimsy),50,R.drawable.ic_wrongkonfet);
